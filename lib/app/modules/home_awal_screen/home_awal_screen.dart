        ...
        child: Scaffold(
            body: Container(
                ...
                child: Column(children: [
                  CustomImageView(imagePath: ImageConstant.imgProfileFreeVe, height: 169.v, width: 174.h),
                  SizedBox(height: 15.v),
                  Text("lbl_hi_amirul_yusuf".tr, style: theme.textTheme.titleLarge),
                  ...
                  CustomElevatedButton(
                      ...
                      rightIcon: Container(
                          ...
                          child: CustomImageView(imagePath: ImageConstant.imgEdit, height: 25.adaptSize, width: 25.adaptSize)),
                      onPressed: () {
                        onTapPOLINEMA();
                      }),
                  SizedBox(height: 15.v),
                  ...
                  CustomElevatedButton(
                      ...
                      buttonStyle: CustomButtonStyles.fillOnPrimaryContainerTL10,
