                    ...
                    child: Form(
                        ...
                        child: Container(
                            ...
                            child: Column(children: [
                              ...
                              SizedBox(height: 2.v),
                              Text("lbl_forgot_password".tr, style: theme.textTheme.headlineSmall),
                              SizedBox(height: 19.v),
                              Container(
                                  width: 234.h,
                                  margin: EdgeInsets.only(left: 33.h, right: 32.h),
                                  child: Text("msg_please_write_your".tr,
                                      maxLines: 3, overflow: TextOverflow.ellipsis, textAlign: TextAlign.center, style: theme.textTheme.bodyMedium)),
                              ...
                              CustomTextFormField(
                                  ...
                                  contentPadding: EdgeInsets.symmetric(horizontal: 22.h, vertical: 14.v),
