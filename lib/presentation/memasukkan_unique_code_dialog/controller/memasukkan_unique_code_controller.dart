...
import 'package:hifdzi_s_application3/presentation/memasukkan_unique_code_dialog/models/memasukkan_unique_code_model.dart';
...
class MemasukkanUniqueCodeController extends GetxController {
  Rx<MemasukkanUniqueCodeModel> memasukkanUniqueCodeModelObj =
      MemasukkanUniqueCodeModel().obs;
}
