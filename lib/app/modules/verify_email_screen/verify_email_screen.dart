        ...
        child: Scaffold(
            ...
            body: Container(
                ...
                child: Column(children: [
                  CustomImageView(imagePath: ImageConstant.imgDownloadForgot, height: 247.v, width: 256.h),
                  SizedBox(height: 3.v),
                  Text("msg_verify_email_address".tr, style: theme.textTheme.headlineSmall),
                  SizedBox(height: 12.v),
                  RichText(
                      text: TextSpan(children: [
                        TextSpan(text: "msg_verification_code2".tr, style: CustomTextStyles.bodyMediumffffffff),
                        TextSpan(text: "lbl_gmail_com".tr, style: CustomTextStyles.bodyMediumff0065fc.copyWith(decoration: TextDecoration.underline))
                      ]),
                      textAlign: TextAlign.left),
                  SizedBox(height: 28.v),
                  Padding(
                      padding: EdgeInsets.only(right: 1.h),
                      child: Obx(() => CustomPinCodeTextField(context: Get.context!, controller: controller.otpController.value, onChanged: (value) {}))),
                  ...
                  SizedBox(height: 6.v),
                  Text("msg_00_22_resend_confirmation".tr, style: theme.textTheme.bodyMedium),
                  SizedBox(height: 5.v)
                ]))));
  }
